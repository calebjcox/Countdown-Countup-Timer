...
class EditTimerAppearanceTest {
    ...
    fun `the editor shows a saved timer's appearance and saves it back`() {
        ...
        assertEquals(
            "opacity slider",
            40f,
            activity.findViewById<Slider>(R.id.scrim_opacity).value,
            0f,
        )
        assertEquals(
            "the opacity slider is off screen for a tinted timer",
            View.VISIBLE,
            activity.findViewById<View>(R.id.scrim_opacity_group).visibility,
        )
        assertEquals(
            "preview footer",
            View.GONE,
        ...
        activity.findViewById<Slider>(R.id.scrim_opacity).value = ScrimOpacity.MAX.toFloat()
        ...
        assertEquals(
            "the opacity slider stayed on screen for a solid backdrop",
            View.GONE,
            activity.findViewById<View>(R.id.scrim_opacity_group).visibility,
        )
        ...
        assertEquals(ScrimOpacity.MAX, stored.scrimOpacity)
    }
}
