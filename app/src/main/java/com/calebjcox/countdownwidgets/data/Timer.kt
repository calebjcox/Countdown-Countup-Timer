...
data class Timer(
     ...
     * way back. Always a value [ScrimOpacity.snap] would return.
     */
    val scrimOpacity: Int = DEFAULT_SCRIM_OPACITY,
    /**
    ...
    fun toJson(): JSONObject = JSONObject().apply {
        ...
        put(KEY_SCRIM_OPACITY, scrimOpacity)
    ...
    companion object {
        ...
        const val DEFAULT_SCRIM_OPACITY = ScrimOpacity.DEFAULT
        ...
        private const val KEY_SCRIM_OPACITY = "scrimOpacity"
        ...
        fun fromJson(json: JSONObject): Timer? = runCatching {
            ...
            Timer(
                ...
                scrimOpacity = ScrimOpacity.snap(
                    json.optInt(KEY_SCRIM_OPACITY, DEFAULT_SCRIM_OPACITY),
                ),
